...
_0x4:
	.DB  0x9
_0x20000:
	.DB  0x43,0x68,0x3A,0x25,0x64,0x20,0x28,0x25
	.DB  0x64,0x20,0x6D,0x76,0x29,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; int ADC_Value=0;
; char adcStringINPUT[16]="               ";

	.DSEG
;  //q2----
;  unsigned int adc_data[LAST_ADC_INPUT-FIRST_ADC_INPUT+1];
;   unsigned int MySaved_Voltage[8]={0,0,0,0,0,0,0,0};
;
;int changedValue_Channel=9;
...
; .FSTART _adc_isr
	...
	IN   R30,SREG
	ST   -Y,R30
; 0000 0029   interupt_ADC_Q2();
	RCALL _interupt_ADC_Q2
; 0000 002A }
	LD   R30,Y+
	OUT  SREG,R30
	LD   R31,Y+
...
; 0000 004E // Timer Period: 0.256 ms
; 0000 004F // Output Pulse(s):
; 0000 0050 // OC0 Period: 0.256 ms Width: 0.256 ms
; 0000 0051 TCCR0=(1<<WGM00) | (1<<COM01) | (0<<COM00) | (1<<WGM01) | (0<<CS02) | (1<<CS01) | (0<<CS00);
	LDI  R30,LOW(106)
	OUT  0x33,R30
...
; 0000 0089 ACSR=(1<<ACD) | (0<<ACBG) | (0<<ACO) | (0<<ACI) | (0<<ACIE) | (0<<ACIC) | (0<<ACIS1) | (0<<ACIS0);
	...
	OUT  0x8,R30
; 0000 008A 
; 0000 008B /*/ADC init in function declered
; 0000 008C  ************************
; 0000 008D  ************************
; 0000 008E  ********************
; 0000 008F */
...
; 0000 009C // RS - PORTC Bit 0
; 0000 009D // RD - PORTC Bit 1
; 0000 009E // EN - PORTC Bit 2
; 0000 009F // D4 - PORTC Bit 4
; 0000 00A0 // D5 - PORTC Bit 5
; 0000 00A1 // D6 - PORTC Bit 6
; 0000 00A2 // D7 - PORTC Bit 7
; 0000 00A3 // Characters/line: 16
...
; 0000 00A6 
; 0000 00A7 
; 0000 00A8 // Choose Initi
; 0000 00A9 
; 0000 00AA     // Question1
; 0000 00AB     ADC_init_Q1();
	RCALL _ADC_init_Q1
; 0000 00AC     Question1();
	RCALL _Question1
; 0000 00AD 
...
; 0001 0033 {
_Save_Voltage_ADC_ByChannel_Q1:
; .FSTART _Save_Voltage_ADC_ByChannel_Q1
...
; 0001 0036      voltage =ADC_To_Voltage(adc_Channel,ADC_Value);
	...
	RCALL _ADC_To_Voltage
	MOVW R16,R30
; 0001 0037      MySaved_Voltage[adc_Channel]= voltage;
	LDD  R30,Y+2
	LDI  R26,LOW(_MySaved_Voltage)
	LDI  R27,HIGH(_MySaved_Voltage)
	LDI  R31,0
	LSL  R30
	ROL  R31
	ADD  R30,R26
...
_Display_Voltage_ByChannel:
; .FSTART _Display_Voltage_ByChannel
; 0001 003A         sprintf(adcStringINPUT,"Ch:%d (%d mv)",adc_Channel,MySaved_Voltage[adc_Channel]);
	ST   -Y,R26
;	adc_Channel -> Y+0
	LDI  R30,LOW(_adcStringINPUT)
	LDI  R31,HIGH(_adcStringINPUT)
	ST   -Y,R31
	ST   -Y,R30
...
; 0001 003B         lcd_puts(adcStringINPUT);
	LDI  R26,LOW(_adcStringINPUT)
	LDI  R27,HIGH(_adcStringINPUT)
	CALL _lcd_puts
; 0001 003C }
	JMP  _0x2080001
; .FEND
...
_Display_Voltage_AllChannels:
; .FSTART _Display_Voltage_AllChannels
; 0001 0040        int i=0;
; 0001 0041        while(i<=7){
	CALL SUBOPT_0x0
;	i -> R16,R17
...
; 0001 0042            Display_Voltage_ByChannel(i);
	MOV  R26,R16
	RCALL _Display_Voltage_ByChannel
...
; 0001 004E            Save_Voltage_ADC_ByChannel_Q1(i);
	MOV  R26,R16
	RCALL _Save_Voltage_ADC_ByChannel_Q1
; 0001 004F            i++;
	__ADDWRN 16,17,1
; 0001 0050        }
	RJMP _0x20009
...
; 0001 0051        Display_Voltage_AllChannels();
	RCALL _Display_Voltage_AllChannels
; 0001 0052 }
_0x2080005:
	LD   R16,Y+
	LD   R17,Y+
...
; 0001 005B     if (++input_index > (LAST_ADC_INPUT-FIRST_ADC_INPUT))
	LDS  R26,_input_index_S0010008000
	SUBI R26,-LOW(1)
	STS  _input_index_S0010008000,R26
	CPI  R26,LOW(0x8)
	BRLO _0x2000C
; 0001 005C        input_index=0;
	LDI  R30,LOW(0)
	STS  _input_index_S0010008000,R30
...
_Detect_Voltage_change:
; .FSTART _Detect_Voltage_change
; 0001 0066    int i =0;
...
; 0001 0078             changedValue_Channel=i;
	__PUTWMRN _changedValue_Channel,0,16,17
; 0001 0079             Changed=1;
	LDI  R30,LOW(1)
	STD  Y+6,R30
; 0001 007A             break;
...
; 0001 0081      changedValue_Channel=10; // mean No change
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	STS  _changedValue_Channel,R30
	STS  _changedValue_Channel+1,R31
; 0001 0082 
; 0001 0083  }
_0x20013:
	CALL __LOADLOCR6
...
; 0001 0086     Detect_Voltage_change();
	RCALL _Detect_Voltage_change
; 0001 0087     if( changedValue_Channel<=7 &&changedValue_Channel>=0){
	LDS  R26,_changedValue_Channel
	LDS  R27,_changedValue_Channel+1
	SBIW R26,8
	BRGE _0x20015
	LDS  R26,_changedValue_Channel+1
	TST  R26
	BRPL _0x20016
_0x20015:
	RJMP _0x20014
...
_MySaved_Voltage:
	.BYTE 0x10
_changedValue_Channel:
	.BYTE 0x2
_input_index_S0010008000:
	.BYTE 0x1
__base_y_G101:
	.BYTE 0x4
