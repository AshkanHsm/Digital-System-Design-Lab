...
; 0000 0040 // OC0 Period: 0.256 ms Width: 0 us
...
; 0000 008E 
; 0000 008F     //q2
; 0000 0090         Q2_Function(10);   // input ={  10     30    50     70    90}
	LDI  R26,LOW(10)
	LDI  R27,0
	RCALL _Q2_Function
; 0000 0091 
; 0000 0092         // collected data:
; 0000 0093         /*
; 0000 0094             pwm Duty.C  :  10     30    50     70    90
; 0000 0095             Speed(rpm)  :  17.3   50.4  83.5   116   149
; 0000 0096             Ocr         :  1A     4D    80     B2    E5
; 0000 0097         */
; 0000 0098 
; 0000 0099 
; 0000 009A while (1)
