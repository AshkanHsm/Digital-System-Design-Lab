...
; 0000 001F       Q5_function_TwoPhase();
	RCALL _Q5_function_TwoPhase
; 0000 0020 }
	LD   R30,Y+
	OUT  SREG,R30
	LD   R31,Y+
...
; 0000 0064 // Timer Period: 0.256 ms
; 0000 0065 ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 0066 TCCR2=(0<<PWM2) | (0<<COM21) | (0<<COM20) | (0<<CTC2) | (0<<CS22) | (1<<CS21) | (0<<CS20);
	LDI  R30,LOW(2)
	OUT  0x25,R30
...
; 0000 006B TIMSK=(0<<OCIE2) | (1<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(64)
	OUT  0x39,R30
; 0000 006C 
...
; 0001 0021 {
_Q5_function_TwoPhase:
; .FSTART _Q5_function_TwoPhase
; 0001 0022 
