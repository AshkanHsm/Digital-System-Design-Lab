...
_0x20012:
	.DB  0x30,0x30,0x0,0x0,0x0,0x0,0x0,0x0
	.DB  0x0,0x0
_0x20000:
	.DB  0x25,0x64,0x0
_0x2020003:
...
; 0001 004F       if(control==1)
	...
	LDI  R26,LOW(0)
	LDI  R27,HIGH(0)
	LDI  R30,LOW(_0x20012*2)
	LDI  R31,HIGH(_0x20012*2)
	CALL __INITLOCB
	CALL __SAVELOCR4
;	dataL -> R16,R17
;	dataH -> R18,R19
...
; 0001 005C           Spacetime_Hold=Spacetime;
	LDS  R30,_Spacetime
	LDS  R31,_Spacetime+1
	STS  _Spacetime_Hold,R30
	STS  _Spacetime_Hold+1,R31
...
; 0001 0060       (((Spacetime_Hold-Spacetime)>-1000)|| ((Spacetime_Hold-Spacetime)<1000))&&(Spacetime>0))
	LDS  R26,_Spacetime
	LDS  R27,_Spacetime+1
	LDS  R30,_Spacetime_Hold
	LDS  R31,_Spacetime_Hold+1
	SUB  R30,R26
	SBC  R31,R27
	MOVW R22,R30
	MOVW R0,R30
